      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="space-y-4">
          <div className="bg-white border border-black/10 rounded-2xl p-5 space-y-3">
            ...
            <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Dog's name" className="w-full rounded-lg border border-black/15 px-3 py-2 text-sm text-[#1A1A1A]" />
